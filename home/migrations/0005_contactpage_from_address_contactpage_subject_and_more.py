...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0004_alter_contactpage_intro_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='contactpage',
            name='thank_you_text',
            field=wagtail.fields.RichTextField(blank=True, default='<p>Thank you for contacting us. We will get back to you shortly.</p>', help_text='Text to display after form submission'),
        ),
        migrations.AddField(
            model_name='contactpage',
            name='to_address',
