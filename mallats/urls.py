...
urlpatterns = [
    ...
    path("sitemap.xml", cache_page(3600)(sitemap_index), {"sitemaps": sitemaps, "sitemap_url_name": "sitemaps"}, name="sitemap"),
    path("sitemap-<section>.xml", cache_page(3600)(sitemap), {"sitemaps": sitemaps}, name="sitemaps"),
